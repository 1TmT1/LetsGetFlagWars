...
const main = () => {
    ...
    const CHAT_PORT = 3000; // set a variable to the port of the chat server will listen to (3000)
    const GAME_PORT = 5555; // set a variable to the port of the game server will listen to (5555)
